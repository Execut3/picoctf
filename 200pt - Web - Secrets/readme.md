...
## Solution
Easy challenge. to solve just check source codes and look on places found in source.

In index.html source, hint on /secret/ path
Checking it:
